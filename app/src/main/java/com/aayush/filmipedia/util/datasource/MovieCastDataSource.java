...
public class MovieCastDataSource extends PageKeyedDataSource<Long, MovieCast> {
    ...
    public MovieCastDataSource(FilmipediaApplication application,
    ...
    public void loadInitial(@NonNull PageKeyedDataSource.LoadInitialParams<Long> params,
                            @NonNull PageKeyedDataSource.LoadInitialCallback<Long, MovieCast> callback) {
        ...
        compositeDisposable.add(application.getRestApi().getMovieCredits(movieId,
                ...
                .subscribe(movieCreditsResponse -> {
                    ...
                    callback.onResult(movieCreditsResponse.getCast(),
                            null, 1L);
    ...
    public void loadBefore(@NonNull PageKeyedDataSource.LoadParams<Long> params,
                           @NonNull PageKeyedDataSource.LoadCallback<Long, MovieCast> callback) {
