...
public class MovieResultsAdapter extends PagedListAdapter<Movie, RecyclerView.ViewHolder> {
    ...
    public MovieResultsAdapter(Context context, List<Movie> movieList) {
        super(DIFF_CALLBACK);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_PROGRESS) {
            ...
            return new MovieResultsAdapter.NetworkStateViewHolder(view);
        }
        else {
            View view = inflater.inflate(R.layout.card_movie_results, parent, false);
            return new MovieResultsAdapter.MovieResultsViewHolder(view);
        }
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MovieResultsAdapter.MovieResultsViewHolder) {
            ((MovieResultsAdapter.MovieResultsViewHolder) holder).bindTo(getItem(position));
        }
        else {
            ((MovieResultsAdapter.NetworkStateViewHolder) holder).bindView(networkState);
        }
    }
