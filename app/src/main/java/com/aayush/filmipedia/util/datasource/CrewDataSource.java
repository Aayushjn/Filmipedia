...
public class CrewDataSource extends PageKeyedDataSource<Long, Crew> {
    ...
    public CrewDataSource(FilmipediaApplication application,
    ...
    public void loadInitial(@NonNull LoadInitialParams<Long> params,
                            @NonNull LoadInitialCallback<Long, Crew> callback) {
        ...
        compositeDisposable.add(application.getRestApi()
                ...
                .subscribe(creditsResponse -> {
                    ...
                    callback.onResult(creditsResponse.getCrew(),
                            null, 1L);
    ...
    public void loadBefore(@NonNull LoadParams<Long> params,
                           @NonNull LoadCallback<Long, Crew> callback) {
