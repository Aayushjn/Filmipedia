...
class MovieAdapter(private val context: Context): PagedListAdapter<Movie, RecyclerView.ViewHolder>(DIFF_CALLBACK) {
    ...
    internal inner class MovieViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindTo(movie: Movie?) =
            movie?.let {
                ...
                itemView.text_movie_rating.text = it.voteAverage.toString()
                itemView.text_movie_desc.text = it.overview
